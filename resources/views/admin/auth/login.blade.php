                        ...
                        <form action="{{ route('admin.login') }}" method="POST">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input name="email" type="text" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input name="password" type="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
                                </div>
                            </div>
{{--                            <div class="row">--}}
{{--                                <div class="col-6">--}}
