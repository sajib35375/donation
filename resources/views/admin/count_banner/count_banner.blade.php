        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h2>Count Background Banner</h2>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('update.count') }}" method="POST" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img id="img" src="{{ URL::to('') }}/admin/image/count/{{ $edit->banner }}" alt="">
                    </div>
                </div>
            </div>
        </div>
